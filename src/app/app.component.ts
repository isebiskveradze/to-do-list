...
export class AppComponent {
  title = 'to-do-list';
  message: string=`welome to my ${this.title}`;
  message2=`welome to my ${this.title} 2`
  counter: number = 0;
  clicked: boolean = false;
  stringArr: Array<string> = ['string1', 'string2'];
  unknowProp: any = 'any';
  ...
  handleInputChange(eventParam){
    
    this.imgLink = eventParam.target.value
